...
set_property -dict { PACKAGE_PIN H17   IOSTANDARD LVCMOS33 } [get_ports { EX3[0] }]; #RIGH MOST LED - LSB
set_property -dict { PACKAGE_PIN K15   IOSTANDARD LVCMOS33 } [get_ports { EX3[1] }]; 
set_property -dict { PACKAGE_PIN J13   IOSTANDARD LVCMOS33 } [get_ports { EX3[2] }]; 
set_property -dict { PACKAGE_PIN N14   IOSTANDARD LVCMOS33 } [get_ports { EX3[3] }]; #LEFT MOST LED - MSB

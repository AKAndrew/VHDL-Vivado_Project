...
HD_PWD='C:/Users/Andrew/firstquestion/firstquestion.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log firstquestion.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source firstquestion.tcl -notrace

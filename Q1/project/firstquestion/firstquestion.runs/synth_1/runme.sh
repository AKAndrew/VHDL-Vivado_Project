...
HD_PWD='C:/Users/Andrew/firstquestion/firstquestion.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log firstquestion.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source firstquestion.tcl
